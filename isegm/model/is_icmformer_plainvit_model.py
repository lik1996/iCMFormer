...
from .modeling.models_vit import VisionTransformer_cross_encdecv4, PatchEmbed
...
class PlainVitModel(ISModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.backbone = VisionTransformer_cross_encdecv4(**backbone_params)
    ...
    def backbone_forward(self, image, coord_features=None):
        ...
        backbone_features = self.backbone.forward_backbone_cross_encdec(image, coord_features, self.random_split)
