...
from isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, \
    SBDEvaluationDataset, MOISDataset, PascalVocDataset, BraTSDataset, ssTEMDataset, OAIZIBDataset, HARDDataset
...
def get_dataset(dataset_name, cfg):
    ...
    elif dataset_name == 'COCO_MOIS':
        dataset = MOISDataset(cfg.COCO_MOIS_PATH, split='val')
    elif dataset_name == 'HIM2K':
        dataset = MOISDataset(cfg.HIM2K_PATH)
