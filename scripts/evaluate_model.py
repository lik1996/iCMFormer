...
from isegm.utils.vis import draw_probmap, draw_with_blend_and_clicks, draw_with_clicks
...
def parse_args():
    ...
    group_checkpoints.add_argument('--exp_path', type=bool, default=False,
                                   help='The relative path to the experiment with checkpoints.'
                                        '(relative to cfg.EXPS_PATH)')

    parser.add_argument('--datasets', type=str, default='GrabCut,Berkeley,SBD,DAVIS',
